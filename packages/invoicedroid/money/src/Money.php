...
class Money implements Arrayable, Jsonable, JsonSerializable, Renderable
{
    ...
    protected $amount;
    /**
     * @var \InvoiceDroid\Money\Currency
     */
    protected $currency;
    /**
     * @var string
     ...
     *
     * @param mixed                     $amount
     * @param \InvoiceDroid\Money\Currency $currency
     * @param bool                      $convert
     *
     ...
     * assertSameCurrency.
     *
     * @param \InvoiceDroid\Money\Money $other
     *
     ...
     * add.
     *
     * @param \InvoiceDroid\Money\Money $addend
     *
     * @throws \InvalidArgumentException
     *
     * @return \InvoiceDroid\Money\Money
     ...
     * subtract.
     *
     * @param \InvoiceDroid\Money\Money $subtrahend
     *
     * @throws \InvalidArgumentException
     *
     * @return \InvoiceDroid\Money\Money
